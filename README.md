...
The personal homepage and portfolio for Matuz (Rodrigo dos Santos Lima). Built with React 19, TypeScript, Vite, Tailwind CSS v4, react-router, and Motion. Bilingual (pt-BR default, EN secondary).
