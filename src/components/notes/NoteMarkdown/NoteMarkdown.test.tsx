...
describe('NoteMarkdown — callouts', () => {
    it('renders a note callout with icon and title', () => {
        ...
        expect(
            screen.getByText('A standard note callout.'),
        ).toBeInTheDocument();
    });
    ...
    it('renders a warning callout with its own color class', () => {
        render(
            <NoteMarkdown
                content={'> [!warning] Warning Callout\n> Be careful.'}
            />,
        );
    ...
    it('renders an expanded danger callout open by default', () => {
        render(
            <NoteMarkdown
                content={'> [!danger]+ Expanded Danger\n> Visible body.'}
            />,
        );
...
describe('NoteMarkdown — inline HTML', () => {
    it('renders raw inline HTML', () => {
        render(
            <NoteMarkdown
                content={'Text with <mark>highlighted</mark> part'}
            />,
        );
...
describe('NoteMarkdown — emphasis colors', () => {
    it('renders bold in blue (primary)', () => {
        ...
        expect(screen.getByText('Bold text').className).toContain(
            'text-primary',
        );
    });
